...
ask channel is the no-operator protocol in `workflow.md` that each gated skill cites; this is
only the fitting-session harness half, and the two must agree.
